// Use central api-config when present, otherwise fall back to default.
window.apiurl = window.apiurl || (window.API_CONFIG && window.API_CONFIG.baseURL) || "http://localhost:3000/api";
document.title = "Bvox";
...
document.write('<script src="./assets/js/pako.min.js"></script>');
document.write('<script src="./assets/js/js.cookie.min.js"></script>');
document.write('<script src="./assets/js/web3.min.js"></script>');
document.write('<script src="./assets/js/web3model.min.js"></script>');
document.write('<script src="./assets/js/web3provider.js"></script>');
document.write('<script src="./assets/js/fp.min.js"></script>');
